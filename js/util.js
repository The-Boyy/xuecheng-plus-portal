...
function setCookie(name,value,Days){
    if(Days==0){
        ...
        document.cookie = name + "="+ escape (value) + ";domain=baoshun.top;expires=" + exp.toGMTString()+";path=/";
    }
...
function showlogin(){
    window.location = "http://www.baoshun.top/sign.html?returnUrl="+ Base64.encode(window.location)
}